...
class FavoriteCharactersFragment : Fragment() {
    ...
    private val onClickListener: SearchFragmentAdapter.OnClickListener =
        object : SearchFragmentAdapter.OnClickListener {
            override fun onClickName(position: Int) {
                view?.findNavController()?.navigate(FavoriteCharactersFragmentDirections
    ...
    private var adapter: SearchFragmentAdapter =
        SearchFragmentAdapter(arrayListOf(), onClickListener)
